...
<div class="box box-danger">
  <div class="box-header">
    ...
    <h3 class="box-title">Dina åtgärder</h3>
  ...
  <div class="box-body">
    <ul class="todo-list">
      <li>
        ...
        <!-- todo text -->
        <span class="text">Avsluta checklista för "Allmän säkerhet" Q1 2016</span>
        <!-- Emphasis label -->
        <small class="label label-danger"><i class="fa fa-clock-o"></i> 35 min</small>
  ...
  <div class="box-footer clearfix no-border">
    <button type="button" class="btn btn-default pull-right"><i class="fa fa-plus"></i> Lägg till åtgärd</button>
  </div>
</div>
<!-- /.box -->
